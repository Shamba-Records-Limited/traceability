...
Public-facing roadmap, organised by quarter. Subject to change — submit feedback by opening an issue tagged `roadmap`.
...
- Consumer-facing QR pages with Hashscan links

## Later

- Carbon and water footprint ledger
- Mobile-money payment rails (M-Pesa, Airtel Money)
- IoT integrations (Bluetooth scales, moisture meters, cold-chain)
- SMS / USSD fallback for feature-phone farmers
- Multi-tenant SaaS deployment guides
